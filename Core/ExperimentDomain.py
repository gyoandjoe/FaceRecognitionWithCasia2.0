class ExperimentDomain(object):
    def __init__(self, pkl_train_referenceFullpath,pkl_test_referenceFullpath,max_epochs, with_lr_decay, learning_rate_ratio_decay, initial_learning_rate,
                 saveWeigthsFrecuency, frecuency_lr_decay,batch_size,super_batch_size,pkl_train_referenceList, folderWeightsPath):
