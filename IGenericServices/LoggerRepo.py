...
class LoggerRepo(object):
    ...
    def LogTrain(self, costo, epoch_index,super_batch_index,batch_index,learning_rate, contenido= '',tipo_log=''):
        conn = sqlite3.connect(self.Database_Name)
        c = conn.cursor()
        query = "INSERT INTO LogTraining VALUES (NULL,{0},\'{1}\',\'{2}\',\'{3}\',{4},{5},{6},{7},\'{8}\')".format(
